package com.miftahululum.recyclerview
...
import com.miftahululum.recyclerview.adapter.AdapterTeamBola
import com.miftahululum.recyclerview.databinding.ActivityMainBinding
import com.miftahululum.recyclerview.model.Pemain
        ...
        binding.list.adapter=AdapterTeamBola(this,listPemain,object : AdapterTeamBola.OnClickListener{
            override fun detailData(item: Pemain?) {
                Dialog(this@MainActivity).apply {
                    ...
                    val tinggi  = this.findViewById<TextView>(R.id.txt_tiggibadan)
